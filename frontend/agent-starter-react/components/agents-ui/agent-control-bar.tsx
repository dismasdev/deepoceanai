...
export interface AgentControlBarProps extends UseInputControlsProps {
  ...
  /** Optional callback invoked after a user message is sent from chat input. */
  onUserMessageSent?: (message: string) => Promise<void> | void;
  /** Whether typed chat input should be shown. */
...
export function AgentControlBar({
  ...
  const handleSendMessage = async (message: string) => {
    ...
    if (onUserMessageSent) {
      await onUserMessageSent(message);
    }
  };
